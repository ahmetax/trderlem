...
def turkcemi(metin,fout=None,printet=True):
    ...
    oran = 100*var/say
    if printet==True:
        print("Toplam= {} Bulunan= {} Bulunma Oranı= % {}".format(say,var,oran))
        if fout != None:
            print("Toplam= {} Bulunan= {} Bulunma Oranı= % {}".format(say,var,oran),file=fout,flush=True)
    if oran >= 20: return True
    return False
